...
//				frame.setTitle(fileName);
	...
	public void setLanguage(String lang) {
		...
		switch (lang) {
		case "HTML": {
			path = "D:\\Qspiders\\Project\\NotePadCodeEditor\\htmlFormat.txt";
		}
			break;
		case "Java": {
			path = "D:\\Qspiders\\Project\\NotePadCodeEditor\\javaFormat.txt";
		}
			break;
		case "C": {
			path = "D:\\Qspiders\\Project\\NotePadCodeEditor\\cFormat.txt";
		}
			break;
		case "C++": {
			path = "D:\\Qspiders\\Project\\NotePadCodeEditor\\cppFormat.txt";
		}
			break;
		case "Python": {
			path = "D:\\Qspiders\\Project\\NotePadCodeEditor\\pythonFormat.txt";
		}
			break;
		}
		try {
